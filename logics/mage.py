...
class Mage(object):
    ...
    def get_status(self):
        return "%s has the following stats:Intelligence: %d Stamina %d Base damage: %d HP: %d ;" % (self.name, self.intelligence, self.stamina, self.base_damage, self.health_point)
